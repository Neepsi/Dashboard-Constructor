...
function Figures({ oneBlockVisi, twoBlockVisi,bgColor }) {    
    return(    
        <div className='container'>    
            <div className='row'>   
            <div className={`col bg-secondary m-2 rounded position-relative shadow-sm p-3 mb-3 ${bgColor}`} style={{display:oneBlockVisi,height:'285px'}}>
                ...
                <div className={`col bg-secondary m-2 rounded position-relative shadow-sm p-3 mb-3 ${bgColor}`} style={{display:twoBlockVisi,height:'285px'}}>
